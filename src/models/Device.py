class Device:
    def __init__(self, **kwargs):
        ...
        self.unit_id = kwargs.get('modbus').get('unit_id')
        self.baud_rate = kwargs.get('modbus').get('baud_rate')
        self.data_bits = kwargs.get('modbus').get('data_bits')
        self.parity = kwargs.get('modbus').get('parity')
        self.stop_bits = kwargs.get('modbus').get('stop_bits')
